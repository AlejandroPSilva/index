# 🌿 Refúgio da Serra - Viagens Sustentáveis
  ...
  **Contexto Educativo:** 🎓
  Este projeto foi desenvolvido durante o meu **último ano do Ensino Médio**. Foi criado com fins puramente
  ...
  - **Animações de Scroll:** Elementos que surgem na tela conforme a rolagem da página (efeito Reveal).
  - **Reserva Interativa:** Modal de agendamento de viagens integrado aos pacotes selecionados.
  - **Experiência Visual:** Elementos decorativos como efeito de neblina e folhas animadas para simular o
  ambiente de serra.
  ...
  - **Pacotes:** Detalhamento de preços e serviços inclusos.
  - **Impacto Ambiental:** Contador de ações sustentáveis.
  - **Depoimentos e FAQ:** Prova social e dúvidas frequentes.
