...
if (telefoneCampo) {
  ...
  /* Sugestão automática de DDD pelo GPS */
...
/* ==========================================================
   FUNÇÃO PARA ENVIAR DADOS À API (Render)
========================================================= */
async function enviarParaAPI(endpoint, dados) {
  try {
    const resposta = await fetch(`https://indexo.onrender.com/${endpoint}`, {
      method: "POST",
...
/* ============================================
   FORMULÁRIOS (INTEGRAÇÃO COM API)
============================================ */
...
/* ============================================
   CONTADOR IMPACTO (IntersectionObserver)
============================================ */
...
/* ============================================
   HIGHLIGHT CARD (IntersectionObserver)
============================================ */
